	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
						...
						<li><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;' . __('New Location'), array('action' => 'add'), array('escape' => false)); ?></li>
					</ul>
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<?php foreach ($locations as $location) { ?>
					<tr>
						...
						<td><?php echo h($location['Location']['desc']); ?></td>
						<td><?php echo $this->Time->format($location['Location']['deadline'], '%-d.%-m.&nbsp;%Y'); ?></td>
						<td class="actions">
